...
L1_TESTS=(
  ...
  tests.test_dashboard.DashboardTests.test_dashboard_does_not_draw_approximate_account_chart_without_balance_history
  tests.test_dashboard.DashboardTests.test_dashboard_does_not_render_legacy_summary_only_account_view
