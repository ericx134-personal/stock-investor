...
class DashboardTests(unittest.TestCase):
    def test_kline_chart_exposes_crosshair_ohlcv_tooltips(self):
        ...
        self.assertIn("Use 1D/1W/1M tabs or pinch/scroll on the chart itself", page)
        self.assertIn('data-active-chart-range="126"', page)
    ...
    def test_dashboard_prioritizes_and_escapes_alerts(self):
        ...
        self.assertIn("Portfolio Board", page)
        self.assertIn("Robinhood-style holdings first", page)
        ...
        self.assertIn("Prediction groups", page)
        self.assertIn("BUY / SELL / WAIT grouped by confidence", page)
    ...
    def test_dashboard_separates_exploratory_wave_history_from_live_evidence(self):
        ...
        self.assertIn("raw BUY 70.0%", page)
